...
{  
	...
	unsigned char Msg4[18] = {"Department of ICT:"}; 
 
	SystemInit();  
	SystemCoreClockUpdate();  
	
	LPC_SC->PCONP = 1<<12;
	LPC_PINCON->PINSEL4 = 3<<28;
...
{     
	...
	delay_lcd(25);  LPC_GPIO0->FIOCLR  = EN_CTRL; // EN =0  
	return;      
} 
